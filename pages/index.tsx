...
const App = () => {
    ...
    function updateTime(){
        let current = new Date().toLocaleString('en-US', { timeZone: 'GB' });
        ...
        <>
            ...
            <Wrapper>
                <Container initial="init" animate="load" variants={containerAnim}>
                    <Header variants={childAnim}>Your Name</Header>
                    <Bio variants={childAnim}>** year old <DevLink color="#949eb3" href="https://www.ucas.com/">student</DevLink>.</Bio>
                    <Time variants={childAnim}>
                        <Icons.ClockIcon />
                        {time}
                    </Time>
                    <Contact initial="init" animate="load"  variants={linkAnimParent}>
                        <To variants={linkAnim} color="#ccc" target="_blank" href="https://discord.com/users/647806222925299742">
                            <Icons.DiscordIcon />
                        </To>
                        <To variants={linkAnim} color="#ccc" target="_blank" href="https://www.youtube.com/channel/UCoFcmXpflCZAxL1oa__lFlw/">
                            <Icons.YoutubeIcon />
                        </To>
